    ...
    return (
        <Layout>
            ...
            <div className="flex flex-col text-stone-50 bg-black w-full relative tracking-wider">
                ...
                <section className="md:h-screen flex my-12 flex-col justify-center items-start py-12 relative z-30">
                        ...
                        <div className="hidden md:flex md:flex-row gap-2 h-full w-full overflow-hidden">
                            {instagram_images_desktop.map((image, index) => (
                                <img
                                    ...
                                    width={500}
                                    height={500}
                                    className={`h-[30em] md:h-[500px] ${index === instagram_images_desktop.length - 1 ? 'w-[500px] ' : 'w-2/12'} aspect-[4/10] object-cover transition-all duration-500 opacity-50 scale-100 hover:opacity-100 hover:w-[500px]`}
                                    src={image}
                        ...
                        <div className="flex flex-col md:hidden gap-4 h-1/3 w-full z-20 bg-black">
                            {instagram_images_mobile.map((image, index) => (
                                <img key={index} width={500} height={500}
                                    className={`h-[10em]  ${index === instagram_images_mobile.length - 1 ? 'h-[300px]' : 'h-2/12'} aspect-[4/10] object-cover transition-all duration-500 opacity-50 scale-100 hover:opacity-100 hover:h-[300px]`}
